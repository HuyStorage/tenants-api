...
echo "Build source..."
cd ../source
mvn clean package dependency:copy-dependencies -DoutputDirectory=target/lib -DincludeScope=runtime
cd ../deploy
...
cp ../source/target/tenant-api.jar release/app.jar
cp -r ../source/target/lib release/lib

...
@EnableJpaRepositories(basePackages = {"com.tenant.api.storage.tenant.model", "com.tenant.api.storage.tenant.repository"},
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(new String[]{"com.tenant.api.storage.tenant.model", "com.tenant.api.storage.tenant.repository" });
        ...
        //properties.put(Environment.DIALECT, "org.hibernate.dialect.MySQL5Dialect");//-> mysisam

package com.tenant.api.cfg.tenants.master;
...
@EnableJpaRepositories(basePackages = {"com.tenant.api.storage.master.model", "com.tenant.api.storage.master.repository"},
...
public class MasterDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.tenant.api.storage.master.model", "com.tenant.api.storage.master.repository"});
